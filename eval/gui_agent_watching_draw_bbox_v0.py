    ...
    try:
        ...
        for sample_id in range(0, sample_num):
            try:
                ...
                pc_image_bbox_folder = os.path.join('/Users/aiqihang/code/GUIAgent/images/huawei_bbox', task_name, device, f'step{training_step}', f'sample{sample_id}/')
...
if __name__ == '__main__':
    ...
    max_steps = 15
    task_name = "eval_inquire_stage1_huawei_en" # eval_mobile_r1_complex_inst
    sample_num = 1
