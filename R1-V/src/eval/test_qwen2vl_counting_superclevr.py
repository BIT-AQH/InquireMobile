...
# MODEL_PATH="/home/admin/workspace/aop_lab/R1-V/src/r1-v/saves/qwen25_vl_3b_grpo/checkpoint-17500"
MODEL_PATH="/home/jingxuan.xjx/notebook/models/Qwen2.5-VL-3B-Instruct"
BSZ=64 # reduce it if GPU OOM
OUTPUT_PATH="./logs/counting_results_superclevr_200_qwen25vl_3b_instruct_grpo_17500.json"
PROMPT_PATH="./prompts/superclevr_test200_counting_problems.jsonl"
BASE_DIR="/home/jingxuan.xjx/notebook/datasets/superclevr"
...
QUESTION_TEMPLATE = "{Question} First output the thinking process in <think> </think> and final answer (number) in <answer> </answer> tags." # 50.5%
QUESTION_TEMPLATE = "{Question} Output the final answer (number) in <answer> </answer> tags." # 72.50%
QUESTION_TEMPLATE = "{Question} Output the final answer (number)." # 69.00%
...
for i in data:
    message = [{
        ...
        "content": [
            {
                "type": "image", 
                "image": f"file://{os.path.join(BASE_DIR, i['image_path'])}"
            },
            {
                "type": "text",
